...
function initialEntities(): EntityMap {
  const list: HaEntity[] = [
    ...
    ...config.climate.indoor.temperature.map((id, i) => ent(id, ['23.1', '21.5', '21.8', '22.5', '21.1'][i] ?? '22', { friendly_name: 'Drinnen', unit_of_measurement: '°C' })),
    ent(config.climate.indoor.humidity[0], '69', { friendly_name: 'Drinnen', unit_of_measurement: '%' }),
    ent(config.climate.outdoor.temperature[0], '19.9', { friendly_name: 'Draußen', unit_of_measurement: '°C' }),
    ent(config.climate.outdoor.humidity[0], '72', { friendly_name: 'Draußen', unit_of_measurement: '%' }),
